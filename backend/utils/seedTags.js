...
if (!MONGO_URI) {
  ...
  console.error(
    'Please ensure your .env file in the backend directory contains MONGO_URI=your_mongodb_connection_string'
  );
  process.exit(1);
}
...
const tagData = [
  ...
  { name: 'dinner', category: 'mealType', description: 'Evening meal' },
  {
    name: 'dessert',
    category: 'mealType',
    description: 'Sweet dish usually served after main course',
  },
  ...
  { name: 'snack', category: 'mealType', description: 'Light meal between regular meals' },
  {
    name: 'side dish',
    category: 'mealType',
    description: 'Smaller dish that accompanies a main dish',
  },
  ...
  // Cooking time
  {
    ...
    description: 'Preparation time under 15 minutes',
  },
  {
    name: 'under 30 minutes',
    category: 'cookingTime',
    description: 'Preparation time under 30 minutes',
  },
  ...
  { name: 'quick & easy', category: 'cookingTime', description: 'Fast and simple to prepare' },
  {
    name: 'slow-cooked',
    category: 'cookingTime',
    description: 'Cooked for a long time on low heat',
  },
  ...
  },
  {
    name: 'stir-fried',
    category: 'cookingMethod',
    description: 'Cooked quickly over high heat while stirring',
  },
  {
    name: 'slow-cooked',
    category: 'cookingMethod',
  ...
  { name: 'whole30', category: 'diet', description: 'Whole food based elimination diet' },
  {
    ...
    category: 'diet',
    description: 'Based on foods common to Mediterranean countries',
  },
