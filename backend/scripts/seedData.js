    ...
    [
      {
        ...
        description: "Authentic Roman pasta with crispy guanciale, pecorino cheese, and silky egg sauce. A true Italian classic that's surprisingly simple to make.",
        ingredients: [
        ...
        steps: [
          ...
          { description: "Cut guanciale into small strips and cook in a pan until crispy and golden." },
          { description: "Mix egg yolks with grated pecorino and plenty of black pepper." },
          { description: "Drain pasta, reserving some water. Add to guanciale pan, remove from heat." },
      ...
      },
      {
        ...
        description: "Neapolitan-style pizza with San Marzano tomatoes, fresh mozzarella, and basil. Simple ingredients, extraordinary taste.",
        ingredients: [
        ...
        steps: [
          ...
          { description: "Bake for 8-10 minutes until crust is charred. Add fresh basil and olive oil." }
        ],
        tags: [
          { tag: "Italian", category: "Cuisine" },
    ...
    [
      {
        ...
        description: "Aromatic coconut curry with tender chicken, Thai basil, and vegetables. Creamy, spicy, and absolutely addictive.",
        ingredients: [
        ...
        steps: [
          ...
          { description: "Pour in remaining coconut milk, add vegetables and simmer for 10 minutes." },
      ...
      },
      {
        ...
        description: "Rich tonkotsu-style ramen with crispy pork belly, soft-boiled egg, and all the classic toppings.",
        ingredients: [
    ...
    [
      {
        ...
        description: "Layers of espresso-soaked ladyfingers and mascarpone cream. The ultimate Italian dessert, no baking required.",
        ingredients: [
        ...
        steps: [
          ...
          { description: "Spread mascarpone cream, repeat layers. Refrigerate 4 hours, dust with cocoa." }
        ],
        tags: [
          { tag: "Italian", category: "Cuisine" },
        ...
        photos: [
          { image: "https://images.unsplash.com/photo-1542124948-dc391252a940?w=600" }
        ]
      },
      {
        title: "Chocolate Lava Cake",
        image: "https://images.unsplash.com/photo-1624353365286-3f8d62daad51?w=800",
        description: "Individual molten chocolate cakes with a gooey center. Pure chocolate indulgence in every bite.",
        ingredients: [
        ...
        steps: [
          ...
          { description: "Bake for 12-14 minutes until edges are set but center jiggles. Serve immediately." }
        ],
        tags: [
